...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__account__copyloa__286302EC] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[account] ADD CONSTRAINT [PK__account__F20699F6DFCD96AF] PRIMARY KEY CLUSTERED  ([accountid])
GO
