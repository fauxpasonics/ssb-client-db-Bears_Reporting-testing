...
[new_tm_noteid] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Email__copyloadd__3B40CD36] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Email] ADD CONSTRAINT [PK__Email__0FC8C7C4B32CB642] PRIMARY KEY CLUSTERED  ([activityid])
GO
