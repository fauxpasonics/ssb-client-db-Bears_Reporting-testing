...
[str_quotestatusid] [uniqueidentifier] NULL,
[str_quotestatusidname] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[str_rate] [money] NULL,
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Quote__copyl__656C112C] DEFAULT (getdate())
)
GO
