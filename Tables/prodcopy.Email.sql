...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Email__copyloadd__3E1D39E1] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Email] ADD CONSTRAINT [PK__Email__0FC8C7C47A9AD8F7] PRIMARY KEY CLUSTERED  ([activityid])
GO
