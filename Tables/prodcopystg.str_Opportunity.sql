...
[str_opportunitystatusid] [uniqueidentifier] NULL,
[str_opportunitystatusidname] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Oppor__copyl__5BE2A6F2] DEFAULT (getdate())
)
GO
