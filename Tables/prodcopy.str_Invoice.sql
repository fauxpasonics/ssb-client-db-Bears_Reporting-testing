CREATE TABLE [prodcopy].[str_Invoice]
(
...
[str_invoiceid] [uniqueidentifier] NULL,
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Invoi__copyl__6B24EA82] DEFAULT (getdate()),
[new_partialpaymentrevenue] [money] NULL,
[new_partialpaymentrevenue_base] [money] NULL
)
GO
