...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__SystemUse__copyl__35BCFE0A] DEFAULT (getdate()),
[new_TM_UserID] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ssbpcisdeleted] [bit] NULL
)
GO
